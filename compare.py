...
class CSVComparator:
    ...
    def load_csv_files(self):
        try:
            ...
            print(f"CSV file is empty or corrupt: {e}")
    ...
    def create_result_df(self, only_in_df1, only_in_df2, key1, key2):
        ...
        for col in self.columns:
            ...
            result_df[f'{left_prefix}{col}'] = left_col_values.reindex(range(max_len), fill_value=None)
            result_df[f'{right_prefix}{col}'] = right_col_values.reindex(range(max_len), fill_value=None)
...
# Example usage:
comparator = CSVComparator('config.yml')
